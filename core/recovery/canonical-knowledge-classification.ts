...
export type RecoveryState = "COMPLETE" | "PARTIAL" | "SKELETON" | "IDEA-SPEC" | "DELETED-HISTORICAL" | "UNCLASSIFIED";
export type RecoveryDecision = "KEEP" | "MERGE" | "EVOLVE" | "REBUILD" | "ARCHIVE" | "INVESTIGATE" | "UNCLASSIFIED";
export type LiveState = "SPEC_ONLY" | "UI_ONLY" | "BACKEND_PARTIAL" | "BACKEND_LIVE" | "CONNECTED" | "TESTED" | "DEPLOYED" | "VERIFIED_LIVE" | "UNCLASSIFIED";
