...
export const WATER_FAULT_REGISTRY_DOCTRINE = {
  ...
  safety:
    "Η καταχώρηση δεν αλλάζει το κύριο δίκτυο. Πρώτα αποθηκεύεται ως καταγραφή, μετά ελέγχεται από επιστάτη/founder και μόνο με έγκριση μπορεί να ενημερώσει κοινό χάρτη ή κύριο μητρώο.",
  nextDatabaseStep:
    "Η τρέχουσα έκδοση αποθηκεύει μόνιμα στο κεντρικό Supabase Μητρώο Βλαβών, με offline cache στη συσκευή και ελεγχόμενη πρόσβαση.",
} as const;