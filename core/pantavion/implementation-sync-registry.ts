...
export const sovereignFactoryImplementationItems: ImplementationSyncItem[] = [
  ...
  }),
  {
    ...
    blocker: "Factory PR #315 and recovery/runtime PRs #352-#362 are MERGED only; merge evidence is not deployment or live evidence. PRs #363-#375 are TESTED and unmerged. Production progression requires explicit founder authorization, VERCEL_TOKEN for the scheduler repair path, exact deployed revision, authenticated E2E, RLS isolation, rollback and audit evidence.",
    updatedAt: "2026-09-01T02:10:10.000Z",
  },
];
