...
export const sovereignFactoryImplementationItems: ImplementationSyncItem[] = [
  ...
  testedPullRequestItem({
    id: "recovery-founder-build-decision-receipts",
    title: "Founder AAL2 Build Decision Receipts",
    domain: "owner_control",
    source: "core/recovery/pantavion-recovery-owner-decision.ts",
    branch: "feature/recovery-founder-decision-receipts-20260831",
    pr: 370,
    headRevision: "2ac29620918d61dbf1aabe039f6aca586a23dfb4",
    testRun: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33371554873",
    testedAt: "2026-08-31T08:13:37.000Z",
    auditReference: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33371554873/artifacts/9750361282",
    evidence: [
      "records:82413",
      "decision_sources:279",
      "visibility:founder_only_aal2",
      "same_origin_post:true",
      "append_only_receipts:true",
      "execution_authority:0",
      "agent_grants:0",
      "production_writes:0",
      "migration:authored_not_applied",
      "artifact_bytes:30754729",
      "artifact_sha256:27118e628da54de27ee0870d641299943a6da9c0880056fea08d233111169d54",
    ],
  }),
  testedPullRequestItem({
    id: "recovery-founder-scoped-build-capsules",
    title: "Founder-bound Scoped Build Capsules",
    domain: "recovery",
    source: "core/recovery/pantavion-recovery-scoped-build-capsule.ts",
    branch: "feature/recovery-scoped-build-capsules-20260831",
    pr: 371,
    headRevision: "acbb65664a20423d574fdb3bf672c6ff777ba868",
    testRun: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33376903537",
    testedAt: "2026-08-31T09:23:41.000Z",
    auditReference: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33376903537/artifacts/9752330675",
    evidence: [
      "records:82413",
      "classified_members:31779",
      "scoped_build_capsules:279",
      "blocked_governed_hold:355",
      "blocked_recursive_provenance:50279",
      ...
      "release_authority:0",
      "artifact_bytes:30754729",
      "artifact_sha256:e4ca8386b1c2d2205c6701f684b062fb6615b3935613f8169347c9629b17b913",
    ],
  }),
  testedPullRequestItem({
    id: "recovery-bounded-build-admission",
    title: "Bounded Recovery Build Admission",
    domain: "recovery",
    source: "core/recovery/pantavion-recovery-build-admission.ts",
    branch: "feature/recovery-bounded-build-admission-20260831",
    pr: 372,
    headRevision: "f76aaed13cee9f5b4ac2748b2daf0a50897a06d7",
    testRun: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33403827217",
    testedAt: "2026-08-31T14:45:31.000Z",
    auditReference: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33403827217/artifacts/9762474418",
    evidence: [
      "records:82413",
      "classified_members:31779",
      "bounded_admissions:279",
      "blocked_governed_hold:355",
      "blocked_recursive_provenance:50279",
      "synthetic_inputs_only:true",
      "bounded_sessions:279",
      "completed_steps:0",
      "execution_receipts:0",
      "real_founder_approvals:0",
      "real_technology_clearances:0",
      "real_agent_grants:0",
      "real_budget_grants:0",
      "real_edge_packets:0",
      ...
      "release_authority:0",
      "artifact_bytes:30754729",
      "artifact_sha256:1b5a24972600ebe690bbaa106837aa5cf3be8d0927e8527d2972a1d916582824",
    ],
  }),
  testedPullRequestItem({
    id: "recovery-bounded-step-execution",
    title: "Bounded Recovery Step Execution",
    domain: "recovery",
    source: "core/recovery/pantavion-recovery-bounded-step-execution.ts",
    branch: "feature/recovery-bounded-step-execution-20260831",
    pr: 373,
    headRevision: "c59615c0835dea4a86b4ca81aeb7f14c084ce4d3",
    testRun: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33430377330",
    testedAt: "2026-08-31T19:31:03.000Z",
    auditReference: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33430377330/artifacts/9772479973",
    evidence: [
      "records:82413",
      "classified_members:31779",
      "bounded_sessions:279",
      "bounded_step_receipts:1674",
      "bounded_checkpoints:1953",
      "blocked_governed_hold:355",
      "blocked_recursive_provenance:50279",
      "synthetic_inputs_only:true",
      "real_founder_approvals:0",
      ...
      "artifact_bytes:30754729",
      "artifact_sha256:14527a50249ae39ed265374e3f8418f8905c9954422169f099c1511034b2b376",
    ],
  }),
  testedPullRequestItem({
    id: "recovery-implementation-review-packets",
    title: "Recovery Implementation Review Packets",
    domain: "recovery",
    source: "core/recovery/pantavion-recovery-implementation-review.ts",
    branch: "feature/recovery-implementation-review-packets-20260831",
    pr: 374,
    headRevision: "32151b016a0be53d6dfae2373112faccabe578dd",
    testRun: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33434426097",
    testedAt: "2026-08-31T20:13:28.000Z",
    auditReference: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33434426097/artifacts/9773977207",
    evidence: [
      "records:82413",
      "classified_members:31779",
      "implementation_review_packets:279",
      "bounded_step_receipts:1674",
      "bounded_checkpoints:1953",
      "blocked_governed_hold:355",
      "blocked_recursive_provenance:50279",
      "synthetic_rehearsal_only:true",
      "trusted_repository_attestations:0",
      "real_founder_approvals:0",
      "real_technology_clearances:0",
      "real_agent_grants:0",
      "real_budget_grants:0",
      ...
      "lifecycle_promotions:0",
      "artifact_bytes:30754729",
      "artifact_sha256:ae8fd108e0bdc7d3a849547721f76007be8d45d5686a10006594954ff07985ba",
    ],
  }),
  testedPullRequestItem({
    id: "recovery-repository-attestation-gate",
    title: "Recovery Repository Attestation Gate",
    domain: "recovery",
    source: "core/recovery/pantavion-recovery-repository-attestation.ts",
    branch: "feature/recovery-repository-attestation-gate-20260901",
    pr: 375,
    headRevision: "cab6c5221794be75eacff8944dbcc261f31bb652",
    testRun: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33461241308",
    testedAt: "2026-09-01T02:10:10.000Z",
    auditReference: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33461241308/artifacts/9783310104",
    evidence: [
      "records:82413",
      "classified_members:31779",
      "repository_attestation_evaluations:279",
      "synthetic_rehearsal_blocked:279",
      "blocked_governed_hold:355",
      "blocked_recursive_provenance:50279",
      "ed25519_signature_gate:true",
      "exact_pr_commit_tree_binding:true",
      "required_workflow_gates:3",
      "immutable_artifact_binding:true",
      "replay_protection:true",
      "trusted_real_workspace_attestations:0",
      "real_founder_code_reviews:0",
      "real_lifecycle_eligible_orders:0",
      "real_user_visible_capabilities:0",
      "real_code_mutations:0",
      "canonical_repository_writes:0",
      "production_writes:0",
      "merge_authority:0",
      ...
      "lifecycle_promotions:0",
      "artifact_bytes:30754729",
      "artifact_sha256:e73fd826f90123ec596f22e0395f9498e5bbb2a4d53704fa7fe88e08c500ee60",
    ],
  }),
  testedPullRequestItem({
    id: "founder-offline-intent-workbench",
    title: "Founder Offline Intent Workbench",
    domain: "owner_control",
    source: "core/intent/pantavion-founder-intent-workbench.ts",
    branch: "feature/owner-offline-intent-workbench-20260901",
    pr: 376,
    headRevision: "98df445d6ab0c157dca39d90186388e6ea5b99a2",
    testRun: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33482247384",
    testedAt: "2026-09-01T06:48:00.000Z",
    auditReference: "https://github.com/pandaconnect1/pantavion-planet/actions/runs/33482247384/artifacts/9790495062",
    evidence: [
      "real_coded_capabilities:1",
      "real_tested_capabilities:1",
      "real_route:/owner/control/intent-workbench",
      "founder_only:true",
      "aal2_required:true",
      "offline_execution:true",
      "local_encrypted_vault:true",
      "aes_gcm_256:true",
      "pbkdf2_sha256_iterations:210000",
      "canonical_sha256_receipts:true",
      "encrypted_export_import:true",
      "tamper_detection:true",
      "authority_widening_rejected:true",
      "test_assertions:19",
      "exact_head_workflows_passed:8",
      "synthetic_records_counted_as_implementation:0",
      "real_deployed_capabilities:0",
      "real_verified_live_capabilities:0",
      "production_writes:0",
      "supabase_writes:0",
      "merge_authority:0",
      "deployment_authority:0",
      "release_authority:0",
      "dispatch_artifact_bytes:30754729",
      "dispatch_artifact_sha256:461888f35c97899fd3cb6cf1161caccc678a683a3e4eb0372791e73e0ef73596",
      "runtime_artifact_bytes:19025686",
      "runtime_artifact_sha256:f39c08cb662a832578cb394cc6e850324a8df24b8a8265ffbf4e5fb17f0ff278",
    ],
  }),
  {
    ...
    blocker: "Factory PR #315 and recovery/runtime PRs #352-#362 are MERGED only; merge evidence is not deployment or live evidence. PRs #363-#376 are TESTED and unmerged. Production progression requires explicit founder authorization, VERCEL_TOKEN for the scheduler repair path, exact deployed revision, authenticated E2E, RLS isolation, rollback and audit evidence.",
    updatedAt: "2026-09-01T06:48:00.000Z",
  },
];
