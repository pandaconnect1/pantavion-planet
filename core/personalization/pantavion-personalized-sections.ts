...
const sections: PantavionPersonalizedSection[] = [
  {
    ...
    priority: 100,
    capabilities: [
      { id: "people", title: "Άνθρωποι", description: "Profiles, αιτήματα, συνδέσεις, nearby και block/unblock.", state: "connected", href: "/people", donorPrs: [166, 174, 182, 211] },
      { id: "social-feed", title: "Social", description: "Feed, posts, reactions, comments, media και Social Map foundation.", state: "connected", href: "/social", donorPrs: [174, 175, 182, 189, 211] },
  ...
  },
  {
    ...
    priority: 96,
    capabilities: [
      { id: "translate", title: "Μετάφραση", description: "Canonical provider-aware translation runtime.", state: "connected", href: "/translate", donorPrs: [140, 142, 144, 145, 160, 171, 180] },
  ...
  },
  {
    ...
    priority: 94,
    capabilities: [
      { id: "profile", title: "Προφίλ", description: "Η ταυτότητα εμφάνισης, γλώσσα και προσωπικά στοιχεία σου.", state: "connected", href: "/profile", donorPrs: [173, 188, 197] },
  ...
  },
  {
    ...
    capabilities: [
      ...
      { id: "water", title: "Professional Water / Infrastructure", description: "Protected water network runtime, access controls, range loading, locks και administrator workflow.", state: "connected", href: "/professional/infrastructure/water", donorPrs: [89, 90, 91, 92, 93, 94, 95, 96, 97, 98, 99, 100] },
    ],
  },
  {
  ...
  },
  {
    ...
    capabilities: [
      ...
      { id: "guardian", title: "Guardian / Audit", description: "Runtime safety, AI integrity, translation integrity και production verification gates.", state: "connected", donorPrs: [71, 73, 190, 196] },
