export type PantavionSectionState = "live" | "building" | "foundation";
...
const sections: PantavionPersonalizedSection[] = [
  {
    ...
    priority: 100,
    capabilities: [
      { id: "people", title: "Άνθρωποι", description: "Profiles, αιτήματα, συνδέσεις, nearby και block/unblock.", state: "live", href: "/people", donorPrs: [166, 174, 182, 211] },
      { id: "social-feed", title: "Social", description: "Feed, posts, reactions, comments, media και Social Map foundation.", state: "live", href: "/social", donorPrs: [174, 175, 182, 189, 211] },
      { id: "communities", title: "Κοινότητες & κοινωνικά πλαίσια", description: "Family, Friends, Communities, Professional, Business, Learning, Dating και Elite Society contexts.", state: "building", donorPrs: [138, 174] },
    ],
  },
  {
    id: "communication",
    ...
    priority: 98,
    capabilities: [
      { id: "messages", title: "Μηνύματα", description: "Authenticated conversations και persistent messages.", state: "live", href: "/messages", donorPrs: [166, 172, 184, 211] },
      { id: "chat-translation", title: "Realtime Chat + μετάφραση", description: "Realtime delivery state και per-message translation μέσω του canonical translation runtime.", state: "building", href: "/messages", donorPrs: [146, 184, 211] },
  ...
  },
  {
    ...
    priority: 96,
    capabilities: [
      { id: "translate", title: "Μετάφραση", description: "Canonical provider-aware translation runtime.", state: "live", href: "/translate", donorPrs: [140, 142, 144, 145, 160, 171, 180] },
      { id: "interpreter", title: "Αμφίδρομος Διερμηνέας", description: "Two-speaker flow με MediaRecorder/server STT, translation και speech output.", state: "building", href: "/translate/interpreter", donorPrs: [143, 147, 148, 149, 150, 151, 152, 157, 158, 159, 161, 162, 194, 195, 196, 208, 209, 210] },
      { id: "language-detection", title: "Αυτόματη αναγνώριση γλώσσας", description: "Script-first/model-fallback language detection recovered selectively from historical Interpreter work.", state: "building", donorPrs: [143, 194] },
    ],
  },
  {
    id: "personal-space",
    ...
    priority: 94,
    capabilities: [
      { id: "profile", title: "Προφίλ", description: "Η ταυτότητα εμφάνισης, γλώσσα και προσωπικά στοιχεία σου.", state: "live", href: "/profile", donorPrs: [173, 188, 197] },
      { id: "contacts", title: "Επαφές", description: "Consent-based contacts/import foundation χωρίς να συγχέονται με Pantavion users.", state: "live", href: "/contacts", donorPrs: [166, 173, 174] },
      { id: "personal-media", title: "Φωτογραφίες & αρχεία", description: "Private personal media library με owner-only boundary.", state: "live", href: "/my-media", donorPrs: [173, 174, 183] },
    ],
  },
  {
    id: "identity-trust",
    ...
    priority: 92,
    capabilities: [
      { id: "registration", title: "Εγγραφή & consent", description: "Current production identity model με launch gate και recovered secure registration fields.", state: "building", donorPrs: [188, 197] },
      { id: "protected-identity", title: "Protected / υψηλής ασφάλειας λογαριασμοί", description: "Recovered policy for passkeys/security keys, manual review και protected profiles· απαιτεί πραγματική enrollment/provider verification.", state: "foundation", donorPrs: [188] },
      { id: "owner-safety", title: "Owner / Trust & Safety", description: "Authenticated control surface πάνω σε production Trust & Safety RPCs και AAL2/role gates.", state: "live", donorPrs: [191] },
    ],
  },
  {
    id: "business-market",
    ...
    priority: 80,
    capabilities: [
      { id: "listings", title: "Αγγελίες / Listings", description: "Moderated public listings lifecycle και RLS-backed public state.", state: "building", donorPrs: [138, 164, 168, 189] },
  ...
  },
  {
    ...
    priority: 76,
    capabilities: [
      { id: "media", title: "Media / News / Radio", description: "Rights/provenance-aware media schema και public media feed foundation.", state: "building", href: "/media", donorPrs: [168, 189] },
  ...
  },
  {
    ...
    priority: 72,
    capabilities: [
      { id: "global-connect", title: "Global Connect", description: "Canonical registry 249 country/area codes με truthful readiness evidence.", state: "foundation", donorPrs: [207] },
      ...
      { id: "water", title: "Professional Water / Infrastructure", description: "Protected live water network runtime, access controls, range loading, locks και administrator workflow.", state: "live", href: "/professional/infrastructure/water", donorPrs: [89, 90, 91, 92, 93, 94, 95, 96, 97, 98, 99, 100] },
    ],
  },
  {
  ...
  },
  {
    ...
    capabilities: [
      ...
      { id: "guardian", title: "Guardian / Audit", description: "Runtime safety, AI integrity, translation integrity και production verification gates.", state: "live", donorPrs: [71, 73, 190, 196] },
      { id: "evolution", title: "Evolution / Recovery Engine", description: "Recovered source inventory, founder-vision findings, unfinished-plan ingestion και canonical completion ledger.", state: "foundation", donorPrs: [72, 88, 165] },
    ],
  },
];
