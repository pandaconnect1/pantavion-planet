-- Canonical recovery of Communities + Social Notifications from historical Social Core donors.
-- Truth boundary: schema/UI are implemented here; VERIFIED_LIVE requires production migration + authenticated acceptance tests.
