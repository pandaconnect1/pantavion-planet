-- Hardening follow-up for recovered Communities + Social Notifications.
-- Removes anonymous Data API exposure and prevents arbitrary membership probing.
...
-- Replace the two-argument SECURITY DEFINER helper with a self-only helper.
