...
-- The queue is intentionally not exposed to browser roles. All access goes through
-- founder-authenticated server routes and the service role.
...
-- Defense in depth if authenticated grants are ever introduced later.
