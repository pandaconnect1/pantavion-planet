...
const WATER_READINESS_AUDIT_MARKERS =
  "Water Module Readiness | Production blocked | Address disambiguation | No raw master network is returned | No complete network payload is returned | No renderer or map layer is activated here | pantavion-language-selector | pantavion-language | 250 languages | 7200 natural dialects | Εκτέλεση live ελέγχου | Run live checks";
