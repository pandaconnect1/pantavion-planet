...
export const metadata = {
  ...
  description:
    "Official Cyprus geospatial source federation for roads, hydrography, terrain/elevation, geology and authorized district water-network imports.",
};
        ...
        <section className="mx-auto max-w-7xl">
          <div className="rounded-[2rem] border border-[#d8b45f]/40 bg-[#0a1629] p-5 md:p-8">
            ...
            <h1 className="mt-4 text-3xl font-black md:text-5xl">
              Επίσημα δεδομένα Κύπρου + προστατευμένα δίκτυα ΕΟΑ
            </h1>
            <p className="mt-4 max-w-5xl text-sm leading-7 text-slate-300 md:text-base">
              Δημόσια/επίσημα layers για οδικό και υδρογραφικό δίκτυο, γεωλογία,
              terrain/elevation και φωτογραμμετρία συνδέονται με ξεχωριστές private
              πηγές των ΕΟΑ. Τα επιχειρησιακά δίκτυα σωληνώσεων δεν γίνονται δημόσια.
            </p>

            <div className="mt-6 grid gap-3 md:grid-cols-4">
              {[
                ["Sources", snapshot.totalSources],
                ["Public", snapshot.publicSources],
                ["Authorized", snapshot.authorizedSources],
                ["EOA private slots", snapshot.authorityAgreementSources],
              ].map(([label, value]) => (
