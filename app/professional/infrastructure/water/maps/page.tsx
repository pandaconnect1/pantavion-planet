...
const cards = [
  {
    ...
    status: "Ενεργό",
    description:
      "Ο σημερινός προστατευμένος live χάρτης ύδρευσης για approved users. Δεν αλλάζει και δεν αντικαθίσταται.",
    ...
    <main className="min-h-screen bg-[#06101f] px-4 py-6 text-white">
      <section className="mx-auto max-w-5xl rounded-[2rem] border border-[#d8b45f]/40 bg-[#0a1629] p-5 shadow-2xl shadow-black/40 md:p-8">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-300 md:text-base">
          Ένα καθαρό mobile κέντρο για τους προστατευμένους χάρτες ύδρευσης:
          ...
          επίπεδο. Μόνο approved/founder access. Κανένα raw DWG δεν εκτίθεται.
        </p>
