...
import { createPantavionWaterMapKernelReport } from "@/core/infrastructure/water/water-map-kernel";
import {
...
export async function GET(request: Request) {
  ...
  return NextResponse.json(createPantavionWaterMapKernelReport(), {
    status: 200,
    headers: {
      "Cache-Control": "no-store",
    },
