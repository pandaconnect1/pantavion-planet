...
import { createPantavionWaterStreetHistoryLedgerReport } from "@/core/infrastructure/water/water-street-history-ledger";
import {
...
export async function GET(request: Request) {
  ...
  return NextResponse.json(createPantavionWaterStreetHistoryLedgerReport(), {
    status: 200,
    headers: {
      "Cache-Control": "no-store",
    },
