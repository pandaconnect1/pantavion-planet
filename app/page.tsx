  ...
  return (
    <>
      ...
      <nav
        ...
        className="fixed bottom-4 left-1/2 z-50 flex w-[calc(100%-2rem)] max-w-4xl -translate-x-1/2 flex-wrap items-center justify-center gap-3 rounded-3xl border border-[#f6c85f]/35 bg-[#06111f]/92 px-4 py-3 text-sm shadow-2xl shadow-black/40 backdrop-blur"
      >
