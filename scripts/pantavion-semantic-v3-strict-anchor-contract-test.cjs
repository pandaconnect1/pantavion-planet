...
const strictOwnershipCases = [
  ...
  ['app/readiness/page.tsx', 'Kernel / Guardian / Runtime', 'guardian', 'present'],
  ['core/app/vercel-product-connection-public-surface-wave.ts', 'Kernel / Guardian / Runtime', 'guardian', 'observe'],
  ['app/memory/page.tsx', 'Personal AI / PantaAI', 'memory', 'present'],
  ['core/pantavion-kernel-ledger.ts', 'Kernel / Guardian / Runtime', 'orchestration', 'synchronize'],
  ['scripts/run-kernel-constitution-regeneration-wave.ts', 'Kernel / Guardian / Runtime', 'guardian', 'execute'],
  ['app/dashboard/actions.ts', 'Identity / Auth / Consent', 'authentication', 'update'],
  ['scripts/export-commercial-billing-rail-wave.ts', 'Recovery / Provenance', 'evidence', 'observe'],
  ['scripts/export-global-governance-closure-wave.ts', 'Recovery / Provenance', 'evidence', 'observe'],
  ['scripts/export-human-first-homepage-wave.ts', 'Recovery / Provenance', 'evidence', 'observe'],
  ['scripts/export-secrets-deploy-observability-integration-wave.ts', 'Recovery / Provenance', 'evidence', 'observe'],
  ['scripts/export-security-enforcement-wave.ts', 'Recovery / Provenance', 'evidence', 'observe'],
  ['scripts/export-security-hardening-closure-wave.ts', 'Recovery / Provenance', 'evidence', 'observe'],
  ['scripts/export-tenant-data-access-storage-isolation-wave.ts', 'Recovery / Provenance', 'evidence', 'observe'],
  ['scripts/export-vercel-product-connection-public-surface-wave.ts', 'Recovery / Provenance', 'evidence', 'observe'],
  ['core/pantavion/media-radio-rights-policy.ts', 'Music / Media / Creation', 'media', 'protect'],
  ['core/pantavion/production-seo-metadata.ts', 'Experience / Navigation', 'shell', 'present'],
  ['core/pantavion/release-gates-before-stripe.ts', 'Marketplace / Work / Business', 'business', 'protect'],
  ['core/pantavion/translation-safety-ledger.ts', 'Interpreter / Translation', 'translation', 'protect'],
  ['docs/production-visibility-policy.md', 'Kernel / Guardian / Runtime', 'guardian', 'protect'],
  ['app/evolution/page  export default function EvolutionPage() {.txt', 'Kernel / Guardian / Runtime', 'orchestration', 'present'],
  ['data/recovery/deep-analysis/branches/agent--fix-live-translation-runtime.json', 'Recovery / Provenance', 'evidence', 'observe'],
