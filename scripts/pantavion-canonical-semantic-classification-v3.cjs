...
const sourcePathAnchors = [
  ...
  { module:'Kernel / Guardian / Runtime', subsystem:'orchestration', capability:'execute', strict:true, patterns:[/^app\/api\/kernel\/(analyze|complete|gap-intelligence|intake|product-dna|research-assimilation|run)\/route\.ts$/,/^core\/kernel\/(pantavion-central-ai-kernel-controller|pantavion-evolution-engine)\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'execution', capability:'observe', strict:true, patterns:[/^app\/api\/(health|kernel\/status)\/route\.ts$/,/^core\/pantavion\/(kernel-gap-index|real-backend-claims-registry)\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'execution', capability:'configure', strict:true, patterns:[/^core\/pantavion\/live-backend-contract\.ts$/,/^services\/runtime-types\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'providers', capability:'configure', strict:true, patterns:[/^core\/(canonical\/canonical-registry|platform\/pantavion-registry)\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'guardian', capability:'protect', strict:true, patterns:[/^core\/pantavion\/production-readiness-gates\.ts$/,/^services\/(repo-guardian|build-guardian)\/index\.ts$/,/^\.github\/workflows\/pantavion-(autonomous-guardian|guardian-365|guardian|runtime-safety|deep-branch-analysis)\.ya?ml$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'execution', capability:'execute', strict:true, patterns:[/^services\/kernel-governor\/index\.ts$/,/^\.github\/workflows\/pantavion-(autonomy-supervisor|live-runtime|cloud-agent|runtime-services)\.ya?ml$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'guardian', capability:'update', strict:true, patterns:[/^services\/approval-inbox\/index\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'orchestration', capability:'configure', strict:true, patterns:[/^core\/pantavion\/master-architecture-baseline\.ts$/] },
  { module:'Recovery / Provenance', subsystem:'evidence', capability:'observe', strict:true, patterns:[/^data\/pantavion-source-inventory\/inventory\.json$/,/^docs\/recovery\/recovery_state_manifest\.json$/,/^scripts\/export-final-closure-audit-wave\.ts$/] },
  { module:'Recovery / Provenance', subsystem:'recovery', capability:'recover', strict:true, patterns:[/^scripts\/pantavion-external-source-harvest\.cjs$/,/^\.github\/workflows\/pantavion-canonical-knowledge-v2\.ya?ml$/] },
  { module:'Identity / Auth / Consent', subsystem:'authorization', capability:'configure', strict:true, patterns:[/^core\/app\/tenant-storage-partition-registry\.ts$/] },
  { module:'Identity / Auth / Consent', subsystem:'authorization', capability:'protect', strict:true, patterns:[/^core\/app\/tenant-storage-read-write-guard\.ts$/,/^app\/api\/admission\/route\.ts$/] },
  { module:'Identity / Auth / Consent', subsystem:'authentication', capability:'present', strict:true, patterns:[/^app\/auth\/(register\/page|login\/loginclient)\.tsx$/] },
  { module:'People', subsystem:'relationships', capability:'synchronize', strict:true, patterns:[/^app\/api\/contacts\/import\/route\.ts$/] },
  { module:'People', subsystem:'relationships', capability:'read', strict:true, patterns:[/^app\/contacts\/page\.tsx$/] },
  { module:'People', subsystem:'relationships', capability:'protect', strict:true, patterns:[/^app\/people\/blocks\/(blocks-client|page)\.tsx$/] },
  { module:'Interpreter / Translation', subsystem:'translation', capability:'read', strict:true, patterns:[/^app\/api\/pantavion\/language-coverage\/route\.ts$/] },
  { module:'Interpreter / Translation', subsystem:'translation', capability:'observe', strict:true, patterns:[/^app\/api\/(pantavion\/language-runtime|translate\/status)\/route\.ts$/] },
  { module:'Interpreter / Translation', subsystem:'translation', capability:'translate', strict:true, patterns:[/^app\/api\/translate\/text\/route\.ts$/] },
  { module:'Interpreter / Translation', subsystem:'interpretation', capability:'present', strict:true, patterns:[/^app\/interpreter\/page\.tsx$/] },
  { module:'Interpreter / Translation', subsystem:'translation', capability:'configure', strict:true, patterns:[/^scripts\/force-fix-language-source\.cjs$/] },
  { module:'Interpreter / Translation', subsystem:'translation', capability:'create', strict:true, patterns:[/^scripts\/pantavion-language-work-orders\.cjs$/] },
  { module:'Safety / Trust / Minors', subsystem:'policy', capability:'configure', strict:true, patterns:[/^core\/pantavion\/(public-claims-registry|pantavion-access-model)\.ts$/,/^core\/safety\/human-safety-scenarios\.ts$/] },
  { module:'Safety / Trust / Minors', subsystem:'policy', capability:'protect', strict:true, patterns:[/^core\/pantavion\/public-indexing-policy\.ts$/] },
  { module:'Safety / Trust / Minors', subsystem:'policy', capability:'present', strict:true, patterns:[/^app\/(access-model|governance)\/page\.tsx$/] },
  { module:'Safety / Trust / Minors', subsystem:'policy', capability:'observe', strict:true, patterns:[/^app\/api\/owner\/safety\/health\/route\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'guardian', capability:'observe', strict:true, patterns:[/^app\/backend-claims\/page\.tsx$/] },
  { module:'Safety / Trust / Minors', subsystem:'moderation', capability:'read', strict:true, patterns:[/^app\/api\/owner\/safety\/dossier\/route\.ts$/] },
  { module:'Personal AI / PantaAI', subsystem:'orchestration', capability:'configure', strict:true, patterns:[/^core\/(ai\/pantaai-global-ai-research-doctrine|pantavion\/ai-feature-register)\.ts$/] },
  { module:'Personal AI / PantaAI', subsystem:'orchestration', capability:'execute', strict:true, patterns:[/^core\/(startup\/pantavion-startup-engine|pantavion-evolution-engine)\.ts$/,/^app\/api\/pantavion\/(startup|intelligence\/tick)\/route\.ts$/] },
  { module:'Personal AI / PantaAI', subsystem:'orchestration', capability:'observe', strict:true, patterns:[/^core\/(pantavion-tech-radar|intelligence\/pantavion-market-radar|pantavion\/competitive-intelligence-layer|intelligence\/pantavion-unfinished-plan-ingestion)\.ts$/] },
  { module:'Personal AI / PantaAI', subsystem:'orchestration', capability:'present', strict:true, patterns:[/^app\/(ai-feature-register|signals|pantavion\/radar|intelligence\/competitive)\/page\.tsx$/,/^app\/startup\/startupclient\.tsx$/] },
  ...
  { module:'Maps / World / Water', subsystem:'water', capability:'protect', strict:true, patterns:[/^\.github\/workflows\/pantavion-water-network-lock\.ya?ml$/] },
  { module:'Maps / World / Water', subsystem:'water', capability:'observe', strict:true, patterns:[/^\.github\/workflows\/water-lock-refresh-evidence\.ya?ml$/,/^scripts\/water-guardian-surface-audit\.cjs$/] },
  { module:'Maps / World / Water', subsystem:'water', capability:'configure', strict:true, patterns:[/^core\/water\/water-second-network-source-registry\.ts$/] },
  { module:'Maps / World / Water', subsystem:'water', capability:'read', strict:true, patterns:[/^app\/api\/professional\/infrastructure\/water\/(address\/candidates|b-map\/pdf|history-ledger|map-kernel|master-b\/derived\/tile|help\/inbox)\/route\.ts$/] },
  { module:'Maps / World / Water', subsystem:'water', capability:'create', strict:true, patterns:[/^app\/api\/professional\/infrastructure\/water\/help\/request\/route\.ts$/] },
  { module:'Maps / World / Water', subsystem:'water', capability:'present', strict:true, patterns:[/^app\/professional\/infrastructure\/water\/(accounting|admin|chief|faults|field|help\/inbox|hr|intelligence|supervisor|warehouse)\/page\.tsx$/,/^app\/professional\/infrastructure\/water\/layout\.tsx$/] },
  { module:'Social / Pulse / Communities', subsystem:'publishing', capability:'read', strict:true, patterns:[/^app\/api\/pantavion\/social-global\/route\.ts$/] },
  { module:'Experience / Navigation', subsystem:'shell', capability:'present', strict:true, patterns:[/^app\/(feedback|contact)\/page\.tsx$/,/^app\/not-found\.tsx$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'guardian', capability:'present', strict:true, patterns:[/^app\/readiness\/page\.tsx$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'guardian', capability:'observe', strict:true, patterns:[/^core\/app\/vercel-product-connection-public-surface-wave\.ts$/] },
  { module:'Personal AI / PantaAI', subsystem:'memory', capability:'present', strict:true, patterns:[/^app\/memory\/page\.tsx$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'orchestration', capability:'synchronize', strict:true, patterns:[/^core\/pantavion-kernel-ledger\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'guardian', capability:'execute', strict:true, patterns:[/^scripts\/run-kernel-constitution-regeneration-wave\.ts$/] },
  { module:'Identity / Auth / Consent', subsystem:'authentication', capability:'update', strict:true, patterns:[/^app\/dashboard\/actions\.ts$/] },
  { module:'Recovery / Provenance', subsystem:'evidence', capability:'observe', strict:true, patterns:[/^scripts\/export-(commercial-billing-rail|global-governance-closure|human-first-homepage|secrets-deploy-observability-integration|security-enforcement|security-hardening-closure|tenant-data-access-storage-isolation|vercel-product-connection-public-surface)-wave\.ts$/] },
  { module:'Music / Media / Creation', subsystem:'media', capability:'protect', strict:true, patterns:[/^core\/pantavion\/media-radio-rights-policy\.ts$/] },
  { module:'Experience / Navigation', subsystem:'shell', capability:'present', strict:true, patterns:[/^core\/pantavion\/production-seo-metadata\.ts$/] },
  { module:'Marketplace / Work / Business', subsystem:'business', capability:'protect', strict:true, patterns:[/^core\/pantavion\/release-gates-before-stripe\.ts$/] },
  { module:'Interpreter / Translation', subsystem:'translation', capability:'protect', strict:true, patterns:[/^core\/pantavion\/translation-safety-ledger\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'guardian', capability:'protect', strict:true, patterns:[/^docs\/production-visibility-policy\.md$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'orchestration', capability:'present', strict:true, patterns:[/^app\/evolution\/page  export default function evolutionpage\(\) \{\.txt$/] },
  { module:'Recovery / Provenance', subsystem:'evidence', capability:'observe', strict:true, patterns:[/^data\/recovery\/deep-analysis\/branches\/agent--fix-live-translation-runtime\.json$/] },
  { module:'Experience / Navigation', subsystem:'shell', capability:'configure', strict:true, patterns:[/^app\/(robots|manifest)\.ts$/] },
  { module:'Recovery / Provenance', subsystem:'recovery', capability:'recover', strict:true, patterns:[/^scripts\/pantavion-knowledge-photo-marriage\.cjs$/,/^core\/intelligence\/pantavion-external-source-harvest\.ts$/] },
  { module:'Recovery / Provenance', subsystem:'evidence', capability:'observe', strict:true, patterns:[/^core\/pantavion\/deep-audit-ledger\.ts$/,/^data\/recovery\/deep-analysis\/branches\/fix--guardian-audit-script-repair\.json$/,/^docs\/implementation\/full_ecosystem_live_wave_1_status\.md$/] },
  { module:'Recovery / Provenance', subsystem:'evidence', capability:'create', strict:true, patterns:[/^core\/security\/audit-append-only-writer\.ts$/] },
  { module:'Personal AI / PantaAI', subsystem:'orchestration', capability:'execute', strict:true, patterns:[/^core\/intelligence\/pantaai-engine\.ts$/,/^app\/api\/intelligence\/execute\/route\.ts$/] },
  { module:'Personal AI / PantaAI', subsystem:'orchestration', capability:'present', strict:true, patterns:[/^app\/(intelligence\/execute|startup)\/page\.tsx$/] },
  { module:'Personal AI / PantaAI', subsystem:'orchestration', capability:'read', strict:true, patterns:[/^app\/api\/pantavion\/intelligence\/(build-queue|opportunities)\/route\.ts$/] },
  { module:'Personal AI / PantaAI', subsystem:'orchestration', capability:'observe', strict:true, patterns:[/^app\/api\/pantavion\/intelligence\/(health|status)\/route\.ts$/,/^scripts\/pantavion-market-radar-report\.cjs$/] },
  { module:'Personal AI / PantaAI', subsystem:'orchestration', capability:'configure', strict:true, patterns:[/^scripts\/run-ai-authority-registry-wave\.ts$/,/^core\/pantavion\/ai-sovereignty-roadmap\.ts$/] },
  { module:'Personal AI / PantaAI', subsystem:'memory', capability:'synchronize', strict:true, patterns:[/^scripts\/(run-cognitive-memory-stratification-wave|run-memory-thread-kernel-wave)\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'providers', capability:'observe', strict:true, patterns:[/^core\/pantavion\/sovereignty-ledger\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'providers', capability:'configure', strict:true, patterns:[/^core\/(pantavion-capabilities|pantavion\/capability-registry)\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'guardian', capability:'configure', strict:true, patterns:[/^core\/(kernel-constitution|pantavion\/product-family-taxonomy)\.ts$/,/^core\/pantavion\/(master-ecosystem-doctrine|route-registry)\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'guardian', capability:'protect', strict:true, patterns:[/^core\/pantavion\/(prime-kernel-law|security-hacker-api-checklist)\.ts$/,/^core\/runtime\/pantavion-autonomy-policy\.ts$/,/^docs\/implementation\/runtime-safety-and-capability-broker\.md$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'guardian', capability:'observe', strict:true, patterns:[/^scripts\/run-final-closure-audit-wave\.ts$/,/^services\/control-room-api\/index\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'orchestration', capability:'configure', strict:true, patterns:[/^core\/kernel\/project-intake\/(project-intake-types|project-inventory-types|project-priority-plan-types|project-work-order-types)\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'orchestration', capability:'execute', strict:true, patterns:[/^core\/(pantavion-kernel|pantavion-planner)\.ts$/,/^scripts\/run-kernel-intake-expansion-wave\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'orchestration', capability:'synchronize', strict:true, patterns:[/^scripts\/run-kernel-persistence-wave\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'orchestration', capability:'present', strict:true, patterns:[/^app\/live-core\/page\.tsx$/,/^scripts\/print-kernel-foundation\.ts$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'execution', capability:'execute', strict:true, patterns:[/^scripts\/run-kernel-one-shot\.ts$/,/^\.github\/workflows\/pantavion-continuity-runtime\.ya?ml$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'execution', capability:'observe', strict:true, patterns:[/^scripts\/pantavion-runtime-smoke\.cjs$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'execution', capability:'configure', strict:true, patterns:[/^docs\/deployment\/pantavion_deployment_spine_v1\.md$/] },
  { module:'Kernel / Guardian / Runtime', subsystem:'guardian', capability:'present', strict:true, patterns:[/^app\/inspector\/page\.tsx$/] },
  { module:'Identity / Auth / Consent', subsystem:'authorization', capability:'configure', strict:true, patterns:[/^app\/_pantavion\/role\.ts$/] },
  { module:'Identity / Auth / Consent', subsystem:'consent', capability:'configure', strict:true, patterns:[/^core\/pantavion\/import-world-(consent|legal)-matrix\.ts$/] },
  { module:'Identity / Auth / Consent', subsystem:'consent', capability:'present', strict:true, patterns:[/^app\/import-world\/page\.tsx$/] },
  { module:'Safety / Trust / Minors', subsystem:'moderation', capability:'read', strict:true, patterns:[/^app\/api\/owner\/safety\/cases\/route\.ts$/] },
  { module:'Safety / Trust / Minors', subsystem:'policy', capability:'protect', strict:true, patterns:[/^core\/pantavion\/(adult-restricted-policy|elite-secure-channels-policy)\.ts$/] },
  { module:'Safety / Trust / Minors', subsystem:'minors', capability:'protect', strict:true, patterns:[/^core\/pantavion\/minors-protection-architecture\.ts$/] },
  { module:'Safety / Trust / Minors', subsystem:'trust', capability:'configure', strict:true, patterns:[/^core\/pantavion\/risk-registry\.ts$/] },
  { module:'Safety / Trust / Minors', subsystem:'trust', capability:'observe', strict:true, patterns:[/^core\/pantavion\/security-control-ledger\.ts$/] },
  { module:'Safety / Trust / Minors', subsystem:'policy', capability:'present', strict:true, patterns:[/^app\/(legal|security)\/page\.tsx$/] },
  { module:'Safety / Trust / Minors', subsystem:'minors', capability:'present', strict:true, patterns:[/^app\/minors\/page\.tsx$/] },
  { module:'Interpreter / Translation', subsystem:'translation', capability:'configure', strict:true, patterns:[/^scripts\/final-fix-greek-label\.cjs$/,/^core\/pantavion\/translation-confidence-model\.ts$/] },
  { module:'Interpreter / Translation', subsystem:'interpretation', capability:'present', strict:true, patterns:[/^app\/pantavion\/live-interpreter\/page\.tsx$/] },
  { module:'Social / Pulse / Communities', subsystem:'communities', capability:'create', strict:true, patterns:[/^app\/social\/communities\/actions\.ts$/] },
  { module:'Social / Pulse / Communities', subsystem:'publishing', capability:'update', strict:true, patterns:[/^app\/social\/notifications\/actions\.ts$/] },
  { module:'People', subsystem:'discovery', capability:'present', strict:true, patterns:[/^app\/connect\/page\.tsx$/] },
  { module:'Marketplace / Work / Business', subsystem:'advertising', capability:'present', strict:true, patterns:[/^app\/ads\/page\.tsx$/] },
  { module:'Marketplace / Work / Business', subsystem:'marketplace', capability:'present', strict:true, patterns:[/^app\/market\/page\.tsx$/] },
  { module:'Marketplace / Work / Business', subsystem:'work', capability:'present', strict:true, patterns:[/^app\/work\/page\.tsx$/] },
  { module:'Marketplace / Work / Business', subsystem:'business', capability:'present', strict:true, patterns:[/^app\/(pricing|services)\/page\.tsx$/] },
  { module:'Marketplace / Work / Business', subsystem:'business', capability:'observe', strict:true, patterns:[/^core\/(commercial\/payout-readiness-registry|inspector\/commercial-visibility-inspector)\.ts$/] },
  { module:'Music / Media / Creation', subsystem:'creation', capability:'present', strict:true, patterns:[/^app\/studio\/page\.tsx$/] },
  { module:'Maps / World / Water', subsystem:'mapping', capability:'configure', strict:true, patterns:[/^app\/shared\/types\/geo\.ts$/] },
  { module:'Maps / World / Water', subsystem:'mapping', capability:'read', strict:true, patterns:[/^core\/water\/water-map-b-position-truth\.ts$/] },
  { module:'Maps / World / Water', subsystem:'water', capability:'protect', strict:true, patterns:[/^app\/api\/professional\/infrastructure\/water\/network\/route\.ts$/,/^app\/professional\/infrastructure\/water\/legacy-secret-cleanup\.tsx$/] },
  { module:'Maps / World / Water', subsystem:'water', capability:'present', strict:true, patterns:[/^app\/professional\/infrastructure\/water\/(field\/\[kind\]|a|admin\/help|mobile-founder)\/page\.tsx$/,/^app\/professional\/infrastructure\/water\/water-entry-client\.tsx$/] },
  { module:'Resilience / Offline / Infrastructure', subsystem:'continuity', capability:'synchronize', strict:true, patterns:[/^scripts\/run-cross-device-continuity-wave\.ts$/] },
  { module:'Resilience / Offline / Infrastructure', subsystem:'infrastructure', capability:'configure', strict:true, patterns:[/^core\/pantavion\/custom-domain-checklist\.ts$/] }
];
