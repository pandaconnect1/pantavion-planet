...
eq(sovereignVerificationRecords.length, 11, "all current Sovereign and innovation PRs represented");
eq(new Set(sovereignVerificationRecords.map(record => record.id)).size, 11, "unique catalog IDs");
eq(new Set(sovereignVerificationRecords.map(record => record.pr)).size, 11, "unique PRs");
...
for (const [childPr, parentPr] of [[483,480],[484,483],[485,484],[486,485]]) {
