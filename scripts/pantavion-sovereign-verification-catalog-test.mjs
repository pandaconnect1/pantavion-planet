...
eq(sovereignVerificationRecords.length, 14, "all current Sovereign and innovation PRs represented");
eq(new Set(sovereignVerificationRecords.map(record => record.id)).size, 14, "unique catalog IDs");
eq(new Set(sovereignVerificationRecords.map(record => record.pr)).size, 14, "unique PRs");
...
for (const [childPr, parentPr] of [[483,480],[484,483],[485,484],[486,485],[488,486],[490,486]]) {
