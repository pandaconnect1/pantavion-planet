...
const blockedRoots = ['.next','node_modules','data/water-network-private','data/recovery/canonical-knowledge','data/recovery/canonical-knowledge-v2','data/recovery/imported-pr248','scripts/pantavion-innovation-semantic-atomization.cjs','scripts/pantavion-innovation-semantic-atomization-gate.cjs','.github/workflows/pantavion-innovation-semantic-atomization.yml','scripts/pantavion-innovation-capability-mapping.cjs','scripts/pantavion-innovation-capability-mapping-gate.cjs','.github/workflows/pantavion-innovation-capability-mapping.yml','scripts/pantavion-innovation-semantic-overlap-review.cjs','scripts/pantavion-innovation-semantic-overlap-review-gate.cjs','.github/workflows/pantavion-innovation-semantic-overlap-review.yml','data/recovery/innovation-semantic-overlap-review','data/recovery/innovation-capability-mapping','data/recovery/innovation-semantic-atomization','data/recovery/innovation-master-register/manifest.json','data/recovery/innovation-master-register/innovation-master-register.json','data/recovery/innovation-master-register/innovation-master-register.csv','data/recovery/innovation-master-register/innovation-family-map.json','data/runtime-reports/latest-founder-vision-ingestion.json','data/runtime-reports/latest-unfinished-plan-ingestion.json'];
