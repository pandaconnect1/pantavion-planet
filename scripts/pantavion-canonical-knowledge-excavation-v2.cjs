...
const blockedRoots = ['.next','node_modules','data/water-network-private','data/recovery/canonical-knowledge','data/recovery/canonical-knowledge-v2','data/recovery/imported-pr248','scripts/pantavion-innovation-semantic-atomization.cjs','scripts/pantavion-innovation-semantic-atomization-gate.cjs','.github/workflows/pantavion-innovation-semantic-atomization.yml','scripts/pantavion-innovation-capability-mapping.cjs','scripts/pantavion-innovation-capability-mapping-gate.cjs','.github/workflows/pantavion-innovation-capability-mapping.yml','scripts/pantavion-innovation-semantic-overlap-review.cjs','scripts/pantavion-innovation-semantic-overlap-review-gate.cjs','.github/workflows/pantavion-innovation-semantic-overlap-review.yml','data/recovery/innovation-semantic-overlap-review','scripts/pantavion-innovation-maturity-evidence-review.cjs','scripts/pantavion-innovation-maturity-evidence-review-gate.cjs','.github/workflows/pantavion-innovation-maturity-evidence-review.yml','data/recovery/innovation-maturity-evidence-review','data/recovery/innovation-capability-mapping','data/recovery/innovation-semantic-atomization','data/recovery/innovation-master-register/manifest.json','data/recovery/innovation-master-register/innovation-master-register.json','data/recovery/innovation-master-register/innovation-master-register.csv','data/recovery/innovation-master-register/innovation-family-map.json','data/runtime-reports/latest-founder-vision-ingestion.json','core/sovereign/founder-innovation-review-preflight.ts','scripts/pantavion-founder-innovation-review-preflight-test.mjs','.github/workflows/pantavion-founder-innovation-review-preflight.yml','app/api/owner/innovation-review','app/owner/control/innovation-review','data/runtime-reports/latest-unfinished-plan-ingestion.json'];
